...
export default function Login() {
 ...
 const handleInputChange = (e) => {
  ...
  const handleSubmit = async (event) => {
    ...
    // Check if all required fields and file are provided
    if (!file) {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8080/student/api/upload', formData, {
        headers: {
      ...
      setResponseMessage(`Error: ${error.response ? error.response.data : error.message}`);
        ...
        /*if (res.status === 200) {
          Swal.fire({
            title: "Lecturer login successfully!",
            text: "Good job!",
            icon: "success"
          }); setVal(val + 1);
        }*/
    ...
    <>
        ...
        <div className='form-container'>
          ...
          />
              ...
              <div style={{ display: "flex" }}>&nbsp;&nbsp;&nbsp;&nbsp;<label><i class="fa-solid fa-circle-user"></i></label>
                &nbsp;<input type="text" name="name" placeholder="name" class="form-input" required onChange={handleInputChange} />
                &nbsp;&nbsp;&nbsp;&nbsp;
                <label><i class="fa-regular fa-envelope"></i></label> &nbsp;
                <input type="email" name="email" placeholder=" email" class="form-input" required onChange={handleInputChange} /><br /><br /><br />
          ...
          <form  onSubmit={handleSubmit} >
            <fieldset class="form-fieldset2">
              ...
              <div style={{ display: "flex" }}>&nbsp; &nbsp;&nbsp;
                ...
                <input className="inp" type="text" name="village" placeholder="village" required onChange={handleInputChange} /><br /><br /><br />
          ...
          <form  onSubmit={handleSubmit} >
            <fieldset class="form-fieldset2">
              ...
              <br /><div style={{ display: "flex" }}>&nbsp; &nbsp;&nbsp; &nbsp;
                ...
                &nbsp;&nbsp;<input className="inp" type="text" name="schoolAddress" placeholder="school address" required onChange={handleInputChange} />
                &nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp; &nbsp; <label className="icon-label"><i className="fa-solid fa-droplet"></i></label> &nbsp;
                <input className="inp" type="number" name="schoolPincode" placeholder="pincode" required onChange={handleInputChange} /><br /><br /><br />
      ...
      <div id="stu4" style={{ display: "flex", gap: "0px", marginLeft: "-60px" }}>
        ...
        <div className='form-container2'>
          ...
          <form  onSubmit={handleSubmit} >
            <fieldset  class="form-fieldset2">
              ...
              <br /><div style={{ display: "flex" }}>&nbsp;&nbsp; &nbsp;&nbsp;
                ...
                <input className="inp" type="date" name="year" placeholder="year" onChange={handleInputChange} />
                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                &nbsp;  <label className="icon-label"><i className="fa-solid fa-layer-group"></i></label> &nbsp;
              ...
              <br /><div style={{ display: "flex" }}>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <input className="inp" type="date" name="joiningDate" placeholder="dob of join" required onChange={handleInputChange} />
                &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <label className="icon-label"><i className="fa-regular fa-envelope"></i></label> &nbsp;
                <input className="inp" type="text" name="collegeAddress" placeholder="address of college" required onChange={handleInputChange} /><br /><br /><br />
              </div><br /><div style={{ display: "flex" }}>&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          {responseMessage && <div id="response"><p>{responseMessage}</p></div>}
